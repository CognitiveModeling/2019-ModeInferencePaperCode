...
public final class DoubleTools {
    ...
    public static void copy(
        ...
        // int o2 = resultoffset;
        //
        System.arraycopy(data, dataoffset, result, resultoffset, size);
        /*
    ...
    public static void fill(
        ...
        fill(result, 0, result.length, value);
    }
    ...
    public static double rnd(
        ...
        final double width = ubd - lbd;
        //
        return (rnd.nextDouble() * width) + lbd; 
    }
    
    /*
    public static double rndPowerLow(
        final Random rnd,
        ...
        final double exp = Math.abs(exponent);
        final double width = ubd - lbd;
        final double x = Math.pow(rnd.nextDouble(), exp);
        //
        return (x * width) + lbd; 
    }
    */ 
    ...
    /*  
    public static double rndPowerHigh(
        final Random rnd,
        final double exponent,
        double lbd,
        double ubd
        ...
        final double exp = Math.abs(exponent);
        final double width = ubd - lbd;
        final double x = 1.0 - Math.pow(rnd.nextDouble(), exp);
        //
        return (x * width) + lbd; 
    } 
    */
    ...
    public static double[] repeat(final double[] data, final int times) {
    	final double[] result = new double[data.length * times];
    	int offset = 0;
    	for (int i = 0; i < times; i++) {
    		DoubleTools.copy(data, 0, result, offset, data.length);
    		offset += data.length;
    	}
    	return result;
    }
    ...
    public static void fill(
        ...
        //int o = resultoffset;
        //
        Arrays.fill(result, resultoffset, resultoffset + size, value);
        /*
        for (int i = 0; i < size; i++) {
            result[o++] = value;
        }
    ...
    public static String asString(final double value) {
        //
    ...
    public static String asString(
        ...
        return asString(data, 0, 1, data.length, delimiter, decimals);
    }
    ...
    public static String asString(
        ...
        return asString(data, offset, 1, size, delimiter, decimals);
    }
    ...
    public static String asString(
    	...
    	return asString(data, 0, 1, data.length, delimiter);
    }
